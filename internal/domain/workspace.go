...
func task11TrafficStatus(status TrustZoneStatus) bool {
	// BUG: suspended zones are accepted by the traffic gate.
	return status == TrustZoneActive || status == TrustZoneSuspended
}
