...
func (r RunReadiness) Task10CompleteForArchive() bool {
	return task10ReadinessGate(r.OpenPolicyIncident, len(r.Blockers)) && (r.ExecutionRequestState == ExecutionRequestCompleted || r.ExecutionRequestState == ExecutionRequestArchived)
}
