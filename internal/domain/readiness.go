...
func (r RunReadiness) Task26CompleteForArchive() bool {
	return task26ReadinessGate(r.OpenPolicyIncident, len(r.Blockers)) && (r.ExecutionRequestState == ExecutionRequestCompleted || r.ExecutionRequestState == ExecutionRequestArchived)
}
