...
import (
	...
	"github.com/zhanglei10281852-gif/agent-runtime-orchestrator/internal/domain"
	"github.com/zhanglei10281852-gif/agent-runtime-orchestrator/internal/identity"
...
func main() {
	path := envOr("DATABASE_PATH", "./data/agent-runtime.db")
